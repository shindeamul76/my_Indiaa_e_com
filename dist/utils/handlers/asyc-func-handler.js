...
const common_types_1 = require("@myIndiaa/utils/types/common-types");
        ...
        Promise.resolve(requestHandler(req, res, next)).catch((error) => {
            if (error.issues) {
                ...
                res
                    ...
                    .json(new api_error_handler_1.ApiError(http_status_codes_1.StatusCodes.BAD_REQUEST, common_types_1.VALIDATION_ERROR, errorResponse));
            }
