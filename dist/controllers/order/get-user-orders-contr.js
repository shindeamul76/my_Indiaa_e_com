...
exports.getUserOrders = (0, asyc_func_handler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.params.userId;
    const userOders = yield (0, order_query_lib_1.getOrderByUserIdQuery)(userId);
