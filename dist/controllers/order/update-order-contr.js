...
exports.updateExistingOrder = void 0;
...
exports.updateExistingOrder = (0, asyc_func_handler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const body = order_validation_1.schemaOrderEditBodyParams.parse(req.body);
    ...
    ;
    const updateOrder = yield (0, order_query_lib_1.updateOrderQuery)(id, body);
    const publicData = order_validation_1.schemaOrderReadPublic.parse(updateOrder);
    return res.status(http_status_codes_1.StatusCodes.OK).json(new api_response_handler_1.ApiResponse(http_status_codes_1.StatusCodes.OK, publicData, order_type_1.ORDER_UPDATE_SUCCESS));
}));
