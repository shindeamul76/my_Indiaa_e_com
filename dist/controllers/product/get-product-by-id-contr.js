...
exports.getProduct = (0, asyc_func_handler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const publicData = product_validaton_1.schemaProductReadPublic.parse(existingProduct);
    return res.status(http_status_codes_1.StatusCodes.OK).json(new api_response_handler_1.ApiResponse(http_status_codes_1.StatusCodes.OK, publicData, product_type_1.PRODUCT_FETCH_SUCCESS));
}));
